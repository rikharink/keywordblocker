...
export class Options {
    ...
    constructor(generalSettingsController: GeneralSettingsController,
...
new Settings().load().then(settings => {
    new Options(new GeneralSettingsController(settings), new KeywordSettingsController(settings), new ChannelSettingsController(settings)).initialize();
});
